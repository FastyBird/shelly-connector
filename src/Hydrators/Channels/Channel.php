...
namespace FastyBird\Connector\Shelly\Hydrators\Channels;
...
final class Channel extends DevicesHydrators\Channels\Channel
{
	...
	): Entities\Devices\Device
	{
		...
		throw new JsonApiExceptions\JsonApiError(
			...
			strval($this->translator->translate('//shelly-connector.base.messages.invalidRelation.heading')),
			strval($this->translator->translate('//shelly-connector.base.messages.invalidRelation.message')),
			[
