 ...
 * @author         Adam Kadlec <adam.kadlec@fastybird.com>
 *
 * @phpstan-extends DevicesModuleSchemas\Devices\DeviceSchema<Entities\IShellyDeviceEntity>
 */
final class ShellyDeviceSchema extends DevicesModuleSchemas\Devices\DeviceSchema
{
	 ...
	 */
	public const SCHEMA_TYPE = MetadataTypes\ConnectorSourceType::SOURCE_CONNECTOR_SHELLY . '/device/' . Entities\ShellyDeviceEntity::DEVICE_TYPE;
